...
class DataLoader():
    ...
    def init_task_dependent_variables(self):
        ...
        elif 145 <= self.exp_counter < 200 or 300 <= self.exp_counter <=400:
            self.fs = 500
            self.channel_dict = {'P7': 1,
                                 'P4': 2,
                                 'Cz': 3,
    ...
    def load_data(self):
        ...
        if self.exp_counter == 0:
            ...
            self.base_folder = "..\\records/Pilot_right_wrist_extension_1_2020-04-27/Run1"
            ...
            self.base_folder = "..\\records/Pilot_right_wrist_extension_1_2020-04-27/Run2"
            ...
            self.base_folder = "..\\records/Pilot_right_wrist_flexion_1_2020-04-27/Run1"
            ...
            self.base_folder = "..\\records/Pilot_right_wrist_flexion_1_2020-04-27/Run2"
            ...
            self.base_folder = "..\\records/pilot_right_fisting_1_2020-04-27/Run1"
            ...
            self.base_folder = "..\\records/pilot_right_fisting_1_2020-04-27/Run2"
            ...
            self.base_folder = "..\\records/pilot_right_index_extension_1_2020-04-27/Run1"
            ...
            self.base_folder = "..\\records/pilot_right_index_extension_1_2020-04-27/Run2"
            ...
            self.base_folder = "..\\records/pilot_right_reaching_with_object_1_2020-04-27/Run1"
            ...
            self.base_folder = "..\\records/pilot_right_reaching_with_object_1_2020-04-27/Run2"
            ...
            self.base_folder = "..\\records/pilot_right_reaching_without_object_1_2020-04-27/Run1"
            ...
            self.base_folder = "..\\records/pilot_right_reaching_without_object_img_2020-04-27/Run1"
            ...
            self.base_folder = "..\\records/pilot_left_wrist_extension_1_2020-04-30/Run1"
            ...
            self.base_folder = "..\\records/pilot_left_wrist_extension_1_2020-04-30/Run2"
            ...
            self.base_folder = "..\\records/pilot_left_wrist_flexion_1_2020-04-30/Run1"
            ...
            self.base_folder = "..\\records/pilot_left_wrist_flexion_1_2020-04-30/Run2"
            ...
            self.base_folder = "..\\records/pilot_left_fisting_1_2020-04-30/Run1"
            ...
            self.base_folder = "..\\records/pilot_left_fisting_1_2020-04-30/Run2"
            ...
            self.base_folder = "..\\records/pilot_left_index_extension_1_2020-04-30/Run1"
            ...
            self.base_folder = "..\\records/pilot_left_index_extension_1_2020-04-30/Run2"
            ...
            self.EB_removed_data = np.transpose(self.EB_removed_eeg['ans'])
            self.base_folder = "..\\records/pilot_left_reaching_with_object_1_2020-04-30/Run1"
            ...
            self.EB_removed_data = np.transpose(self.EB_removed_eeg['ans'])
            self.base_folder = "..\\records/pilot_left_reaching_with_object_1_2020-04-30/Run2"
        elif self.exp_counter == 22:
            self.exp_name = "left reaching without object exe"
            # trial_removel_list = [10, 28, 30, 33, 34]
            self.base_folder = "..\\records/pilot_left_reaching_without_object_1_2020-04-30/Run1"
            ...
            self.base_folder = "..\\records/pilot_left_reaching_without_object_1_2020-04-30/Run2"
            ...
            self.base_folder = "..\\records\Jiansheng_right_reaching_with_object_2_2020-05-22\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_right_reaching_with_object_2_2020-05-22\Run2"
            ...
            self.base_folder = "..\\records\Jiansheng_right_reaching_without_object_2_2020-05-22\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_right_reaching_without_object_2_2020-05-22\Run2"
            ...
            self.base_folder = "..\\records\Jiansheng_right_wrist_extension_2_2020-05-22\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_right_wrist_extension_2_2020-05-22\Run2"
            ...
            self.base_folder = "..\\records\Jiansheng_right_wrist_flexion_2_2020-05-22\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_right_wrist_flexion_2_2020-05-22\Run2"
            ...
            self.base_folder = "..\\records\Jiansheng_right_fsting_2_2020-05-22\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_right_fsting_2_2020-05-22\Run2"
            ...
            self.base_folder = "..\\records\Jiansheng_right_index_extension_2_2020-05-22\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_right_index_extension_2_2020-05-22\Run2"
            ...
            self.base_folder = "..\\records\Jiansheng_eye_fixed_2020-05-25\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_watching_cue_2020-05-25\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_10_IEexe_10_rest_2020-05-25\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_index_extension_rest_random_2020-05-25\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_index_extension_random_interval_new_2020-05-28\Run1"
            ...
            self.base_folder = "..\\records\Jiansheng_right_index_extension_10_rest_10_exe_2020-05-28\Run1"
            ...
            self.base_folder = r"..\records\Ailin_reaching_with_object_1_2020-05-07\Run1"
        elif self.exp_counter == 43:
            self.exp_name = "Ailin left reaching with object img"
            self.base_folder = r"..\records\Ailin_reaching_with_object_1_2020-05-07\Run2"
        elif self.exp_counter == 44:
            self.exp_name = "Ailin left reaching without object exe"
            self.base_folder = r"..\records\Ailin_reaching_without_object_1_2020-05-07\Run1"
        elif self.exp_counter == 45:
            self.exp_name = "Ailin left reaching without object img"
            self.base_folder = r"..\records\Ailin_reaching_without_object_1_2020-05-07\Run2"
        elif self.exp_counter == 46:
            self.exp_name = "Ailin left wrist flexion exe"
            self.base_folder = r"..\records\Ailin_left_wrist_flexion_1_2020-05-06\Run1"
        elif self.exp_counter == 47:
            self.exp_name = "Ailin left wrist flexion img"
            self.base_folder = r"..\records\Ailin_left_wrist_flexion_1_2020-05-06\Run2"
        elif self.exp_counter == 48:
            self.exp_name = "Ailin left wrist extension exe"
            self.base_folder = r"..\records\Ailin_left_wrist_extension_1_2020-05-06\Run1"
        elif self.exp_counter == 49:
            self.exp_name = "Ailin left wrist extension img"
            self.base_folder = r"..\records\Ailin_left_wrist_extension_1_2020-05-06\Run2"
        elif self.exp_counter == 50:
            self.exp_name = "Ailin left index extension exe"
            self.base_folder = r"..\records\Ailin_index_extension_1_2020-05-07\Run1"
        elif self.exp_counter == 51:
            self.exp_name = "Ailin left index extension img"
            self.base_folder = r"..\records\Ailin_index_extension_1_2020-05-07\Run2"
        elif self.exp_counter == 52:
            self.exp_name = "Ailin left fisting exe"
            self.base_folder = r"..\records\Ailin_left_fisting_1_2020-05-06\Run1"
        elif self.exp_counter == 53:
            self.exp_name = "Ailin left fisting img"
            self.base_folder = r"..\records\Ailin_left_fisting_1_2020-05-06\Run2"
        elif self.exp_counter == 100:
            self.exp_name = " Jiansheng_NE_10rest+10FXexe"
            self.base_folder = "..\\records\Jiansheng_NE_10rest+10FXexe_2020-06-22\Run1"
        elif self.exp_counter ==101:
            self.exp_name = " NE pure rest"
            self.base_folder = "..\\records\Jianshen_NE_pure_rest_2020-06-22\Run1"
        elif self.exp_counter == 102:
            self.exp_name = "NE pure rest 2"
            self.base_folder = "..\\records\Jiansheng_NE_pure_rest_2_2020-06-22\Run1"
        elif self.exp_counter == 103:
            self.exp_name = "NE random right IE exe"
            self.base_folder = "..\\records\Jiansheng_NE_random_right_IE_3_2020-06-22\Run1"
        elif self.exp_counter == 104:
            self.exp_name = " NE rest + right WE exe"
            self.base_folder = "..\\records\Jiansheng_NE_rest+right_WE_2020-06-22\Run1"
        elif self.exp_counter == 105:
            self.exp_name = " NE rest + right WE img"
            self.base_folder = "..\\records\Jiansheng_NE_right_WE_img_2020-06-22\Run1"
            ...
            self.base_folder = r"..\\records\NE_noise_test1_2020-06-25\Run1"
        elif self.exp_counter == 108:
            self.exp_name = "NE_left_reaching_without_object"
            self.base_folder = r"..\\records\NE_left_CRO_2020-06-25\Run1"
        elif self.exp_counter == 109:
            self.exp_name = "NE_AD"
            self.base_folder = r"..\\records\NE_AD_exe_2020-06-25\Run1"
        elif self.exp_counter == 110:
            self.exp_name = "NE_rest"
            self.base_folder = r"..\records\NE_rest_test_2020-06-30\Run1"
        elif self.exp_counter == 111:
            self.exp_name = "NE_right_IE_exe"
            self.base_folder = r"..\records\NE_IE_right_2020-06-30\Run1"
        elif self.exp_counter == 112:
            self.exp_name = "NE_right_IE_img"
            self.base_folder = r"..\records\NE_IE_right_2020-06-30\Run2"
        elif self.exp_counter == 113:
            self.exp_name = "NE_left_IE_exe"
            self.base_folder = r"..\records\NE_JN_left_IE_exe_2020-06-30\Run1"
        elif self.exp_counter == 114:
            self.exp_name = "NE_Ailin_IE_right_exe"
            self.base_folder = r"..\records\NE_Ailin_IE_right_exe_2020-07-02\Run1"
        elif self.exp_counter == 115:
            self.exp_name = "NE_Ailin_IE_left_exe"
            self.base_folder = r"..\records\NE_Ailin_left_IE_2_exe_2020-07-02\Run1"
        elif self.exp_counter == 116:
            self.exp_name = "NE_Ailin_WE_right_exe"
            self.base_folder = r"..\records\NE_Ailin_right_WE_exe_2020-07-02\Run1"
        elif self.exp_counter == 117:
            self.exp_name = "NE_Ailin_WE_left_exe"
            self.base_folder = r"..\records\NE_Ailin_left_WE_exe_2020-07-02\Run1"
        elif self.exp_counter == 118:
            self.exp_name = "NE_Ailin_RwoO_right_exe"
            self.base_folder = r"..\records\NE_Ailin_right_RwoO_exe_2020-07-02\Run1"
        elif self.exp_counter == 119:
            self.exp_name = "NE_Ailin_RwoO_left_exe"
            self.base_folder = r"..\records\NE_Ailin_left_RwoO_exe_2020-07-02\Run1"
        elif self.exp_counter == 120:
            self.exp_name = "NE_Ailin_AD_exe"
            self.base_folder = r"..\records\NE_Ailin_right_AD_exe_2020-07-02\Run1"
        elif self.exp_counter == 121:
            self.exp_name = "NE_Jiansheng_IE_LR_exe"
            self.base_folder = r"..\records\NE_Jiansheng_IE_new_LR_exe_2020-07-09\Run1"
        elif self.exp_counter == 122:
            self.exp_name = "NE_Jiansheng_WE_LR1_exe"
            self.base_folder = r"..\records\NE_Jiansheng_WE_LR_exe_2020-07-09\Run1"
        elif self.exp_counter == 123:
            self.exp_name = "NE_Jiansheng_WE_LR2_exe"
            self.base_folder = r"..\records\NE_Jianhseng_WE_new_LR_exe_2020-07-09\Run1"
        elif self.exp_counter == 124:
            self.exp_name = "NE_Jiansheng_RwoO_LR1_exe"
            self.base_folder = r"..\records\NE_Jiansheng_RwoO_LR_exe_2020-07-09\Run1"
        elif self.exp_counter == 125:
            self.exp_name = "NE_Jiansheng_RwoO_LR2_exe"
            self.base_folder = r"..\records\NE_Jiansheng_RwoO_LR2_exe_2020-07-09\Run1"
        elif self.exp_counter == 126:
            self.exp_name = "NE_Ailin_IE_LR1_exe"
            self.base_folder = r"..\records\NE_Ailin_IE_LR_1_2020-07-19\Run1"
        elif self.exp_counter == 127:
            self.exp_name = "NE_Ailin_EF_LR1_exe"
            self.base_folder = r"..\records\NE_Ailin_EF_LR_1_2020-07-19\Run1"
        elif self.exp_counter == 128:
            self.exp_name = "NE_Ailin_RwoO_LR1_exe"
            self.base_folder = r"..\records\NE_Ailin_EF_LR_1_2020-07-19\Run1"
        elif self.exp_counter == 129:
            self.exp_name = "NE_Ailin_rest"
            self.base_folder = r"..\records\NE_Ailin_rest_2020-09-08\Run1"
        elif self.exp_counter == 130:
            self.exp_name = "NE_Ailin_RwoO_exe"
            self.base_folder = r"..\records\NE_Ailin_RwoO_exe_2020-09-08\Run1"
        elif self.exp_counter == 131:
            self.exp_name = "NE_Ailin_WE_exe"
            self.base_folder = r"..\records\NE_Ailin_WE_exe_2020-09-08\Run1"
            
        elif self.exp_counter == 200:
            self.exp_name = "BP_Jiansheng_WE_LR_exe"
            self.base_folder = r"..\records\BP_Jiansheng_WE_LR_exe_2020-08-12\Run1"
        elif self.exp_counter == 201:
            self.exp_name = "BP_Jiansheng_RwoO_LR_exe"
            self.base_folder = r"..\records\BP_Jiansheng_RwoO_LR_2020-08-12\Run1"
        elif self.exp_counter == 2000:
            self.exp_name = "BP_EMG_test1"
            self.base_folder = r"..\records\BP_EMG_2020-08-13\Run1"
        elif self.exp_counter == 2001:
            self.exp_name = "BP_EMG_test2"
            self.base_folder = r"..\records\full_test1_2020-09-17\Run1"
        elif self.exp_counter == 2002:
            self.exp_name = "BP_EMG_test3"
            self.base_folder = r"..\records\EMG_test3_2020-09-17\Run1"
        elif self.exp_counter == 202:
            self.exp_name = "BP_Ailin_rest"
            self.base_folder = r"..\records\BP_Ailin_rest2_2020-08-27\Run1"
        elif self.exp_counter == 203:
            self.exp_name = "BP_Ailin_reaching_LR_exe"
            self.base_folder = r"..\records\BP_ailin_reaching_LR_exe_2020-08-27\Run1"
        elif self.exp_counter == 204:
            self.exp_name = "BP_Ailin_WE_LR_exe"
            self.base_folder = r"..\records\BP_Ailin_WE_lr_exe_2_2020-08-27\Run1"
        elif self.exp_counter == 55:
            self.exp_name = "gtec_Ailin_RwoO_LR_exe"
            self.base_folder = r"..\records\gTEC_aILIN_rWOo_lr_2020-09-01\Run1"
        elif self.exp_counter == 56:
            self.exp_name = "gtec_Ailin_WE_LR_exe"
            self.base_folder = r"..\records\gtec_Ailin_WE_LR_exe_2020-09-01\Run1"
        elif self.exp_counter == 57:
            self.exp_name = "gtec_Ailin_RwoO_LR_exe2"
            self.base_folder = r"..\records\GTEC_aILIN_RwoO_LR_exe_2020-09-01\Run1"
        elif self.exp_counter == 205:
            self.exp_name = "BP_Ning_upper_limb"
            self.base_folder = r"..\records\Ning_2020-09-11\Run1"
        elif self.exp_counter == 206:
            self.exp_name = "BP_Ning_AD"
            self.base_folder = r"..\records\Ning_AD_2020-09-11\Run1"
        elif self.exp_counter == 207:
            self.exp_name = "BP_saline_environment"
            self.base_folder = r"..\records\BP_saline_environment_2020-09-14\Run1"
        elif self.exp_counter == 132:
            self.exp_name = "NE_Jiansheng_rest"
            self.base_folder = r"..\records\NE_Jiansheng_rest_2020-09-23\Run1"
...
#             self.mapping = {1: "Idle", 2: 'focus', 3: 'prepare', 4: 'two', 5: 'one', 6: 'task'}
            ...
            self.base_folder = r"..\records\NE_test_EMG_Random_class_2020-10-04\Run1"
            ...
            self.base_folder = r"..\records\NE_Jiansheng_SYNC_test_2020-10-04\Run1"
            self.mapping = {110: "move", 120: "still", 1: "Idle", 2: 'focus', 3: 'prepare', 4: 'two', 5: 'one', 6: 'task'}
        elif self.exp_counter == 140:
            self.exp_name = "NE_timer_test15"
            self.base_folder = r"..\records\NE_timer_test15_2020-10-06\Run1"
            ...
            self.base_folder = r"..\records\NE_new_timer_EMG_test_2020-10-06\Run1"
            self.mapping = {90: "exe", 1: "Idle", 2: 'focus', 3: 'prepare', 4: 'two', 5: 'one', 6: 'task'}
        elif self.exp_counter == 142:
            self.exp_name = "NE_BO_rest"
            self.base_folder = r"..\records\Bo_rest_2020-10-10\Run1"
            self.mapping = {100: "rest", 1: "Idle", 2: 'focus', 3: 'prepare', 4: 'two', 5: 'one', 6: 'task'}
            
        elif self.exp_counter == 143:
            self.exp_name = "NE_BO_3LR"
            self.base_folder = r"..\records\NE_BO_3LR_2020-10-10\Run1"
            ...
            self.base_folder = r"..\records\IEWELR_test1_2020-10-16\Run1"
            self.mapping = {10: "EE_l", 20: "EE_r", 30: "R_l", 40: "R_r", 50: "WE_l", 60: "WE_r", 1: "Idle", 2: 'focus', 3: 'prepare', 4: 'two', 5: 'one', 6: 'task'}
        elif self.exp_counter == 145:
            self.exp_name = "IEWE EMG"
            self.base_folder = r"..\records\EMG_test_2020-10-16\Run1"
            ...
            self.base_folder = r"..\records\Narsimha_WEIE_LR_formal_2020-10-17\Run1"
            ...
            self.base_folder = r"..\records\test1_2020-11-13\Run1"
            self.mapping = {10: "IE_l", 20: "IE_r", 30: "WE_l", 40: "WE_r", 100: "EMG_WE_l",
                            200: "EMG_WE_r", 300: "EMG_IE_l", 400: "EMG_IE_r",
                            1: "Idle", 2: 'focus', 3: 'prepare', 4: 'two', 5: 'one', 6: 'task'}
        elif self.exp_counter == 148:
            self.exp_name = "Rebecca WEIE LR"
            self.base_folder = r"..\records\Rebecca4_2020-11-14\Run1"
            self.mapping = {10: "IE_l", 20: "IE_r", 30: "WE_l", 40: "WE_r", 100: "EMG_WE_l",
                            200: "EMG_WE_r", 300: "EMG_IE_l", 400: "EMG_IE_r",
                            1: "Idle", 2: 'focus', 3: 'prepare', 4: 'two', 5: 'one', 6: 'task'}
            ...
            self.base_folder = r"..\records\Ailin_2021-01-03\Run1"
            self.mapping = {10: "IE_l", 20: "IE_r", 30: "WE_l", 40: "WE_r", 100: "EMG_WE_l",
                            200: "EMG_WE_r", 300: "EMG_IE_l", 400: "EMG_IE_r",
                            1: "Idle", 2: 'focus', 3: 'prepare', 4: 'two', 5: 'one', 6: 'task'}
        elif self.exp_counter == 301:
            self.exp_name = "Jiansheng WEIE LR"
            self.base_folder = r"..\records\Jiansheng_2021-01-06\Run1"
            self.mapping = {10: "IE_l", 20: "IE_r", 30: "WE_l", 40: "WE_r", 100: "EMG_WE_l",
                            200: "EMG_WE_r", 300: "EMG_IE_l", 400: "EMG_IE_r",
                            1: "Idle", 2: 'focus', 3: 'prepare', 4: 'two', 5: 'one', 6: 'task'}
